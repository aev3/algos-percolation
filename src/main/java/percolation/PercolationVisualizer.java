...
public class PercolationVisualizer {
    ...
    public static void main(String[] args) {
        String file  =
                "/development/AlgosPrincetonPartI/data/backwash.txt";
        //In in = new In(args[0]);
        In inputFile = new In(file);      // input file
        int N = inputFile.readInt();         // N-by-N percolation system
        ...
        while (!inputFile.isEmpty()) {
            int i = inputFile.readInt();
            int j = inputFile.readInt();
            perc.open(i, j);
            draw(perc, N);
            StdDraw.show(DELAY);
        }
